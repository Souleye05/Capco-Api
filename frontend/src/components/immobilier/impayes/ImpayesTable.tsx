...
export function ImpayesTable({ loyers, onPaiement, pagination, onPageChange }: ImpayesTableProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            {pagination && onPageChange && (
                <div className="mt-4 px-4 bg-card rounded-2xl border border-border/50 shadow-sm">
                    <Pagination
